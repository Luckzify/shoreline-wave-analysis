...
void modes(int m, int svar, int dvar){
  //int speeds[] = {100,500,1000,3000,5000,6000,7000,7500};
  int speeds[] = {7500};
  for (int speed = 0; speed < 1; speed++){
    Serial.println(speeds[speed]);
    varpulse(speeds[speed],speeds[speed],50,10);
    delay(1000);
  }

  //100	500	1000	3000	5000	6000	8000	10000
  // int speed = 10
  // int dist = 5;
  // if (m == 0){
